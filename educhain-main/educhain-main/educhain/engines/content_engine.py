...
class ContentEngine:
    ...
    def generate_lesson_plan(
        ...
        **kwargs
        ...
        # EDITED LINE: Handle both str and AIMessage objects
        output_text = results if isinstance(results, str) else results.content
        ...
        try:
            ...
            structured_output = parser.parse(output_text)
    ...
    def generate_study_guide(
        ...
        **kwargs
        ...
        try:
            ...
            if '"practice_exercises": []' in output_text or '"practice_exercises":[]' in output_text:
            ...
            if '"case_studies": []' in output_text or '"case_studies":[]' in output_text:
                output_text = output_text.replace(
                    '"case_studies": []',
